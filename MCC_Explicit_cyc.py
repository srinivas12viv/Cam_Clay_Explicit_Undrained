...
print ("This program is for predicting soil's behavior using MCC model in a Cyclic Undrained TRIAXIAL TEST")
...
q_cyc=float(input("Enter peak-peak deviotric stress for cyclic loading:"))
No_cyc=float(input("Number of cyclic loadings:"))

print ("Running Cyclic Triaxial Undrained Test")
